...
%\legend{BERT-\textsubscript{base} \cite{Devlin2019BERTPO},PruneBert \cite{Sanh2020MovementPA},  oBERT\textsubscript{large} \cite{Frantar2021EfficientMA},  PruneOFA\cite{Zafrir2021PruneOF}, oBERTa (Ours)}
